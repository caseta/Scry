...
open class SavedCardsPresenter @Inject constructor(private var sharedPreferencesHelper: SharedPreferencesHelper, var cardRepository: CardRepository) : BasePresenter<SavedCardsContract.View>(), SavedCardsContract.Presenter {
