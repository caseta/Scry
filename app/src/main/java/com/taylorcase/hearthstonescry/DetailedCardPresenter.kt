...
open class DetailedCardPresenter @Inject constructor(private var sharedPreferencesHelper: SharedPreferencesHelper) : BasePresenter<DetailedCardContract.View>(), DetailedCardContract.Presenter {
