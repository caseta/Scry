...
import com.taylorcase.hearthstonescry.FragmentTest
...
class NavDrawerFragmentTest : FragmentTest() {
    ...
    @Test fun testOnStartLoadsHeroIcon() {
    ...
    @Test fun testOnUpdateHeroClickStartsSelectHeroActivity() {
        val fragment = startFragment(NavDrawerFragment()) as NavDrawerFragment
    ...
    @Test fun testOnSavedCardsClickStartsSavedCardsActivity() {
        val fragment = startFragment(NavDrawerFragment()) as NavDrawerFragment
